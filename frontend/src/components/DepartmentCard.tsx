...
export const DepartmentCard = ({
  ...
  return (
    <div
      key={department._id}
      className="bg-white md:p-6 p-4 rounded-xl border border-slate-200 hover:shadow-md transition-shadow flex items-start justify-between"
    >
      ...
      <div className="flex-1">
        ...
        <div className="space-y-2 text-sm text-slate-600 md:ml-15 w-full">
          ...
          <div className="flex items-center gap-2">
            ...
            <span>Manager: {getManagerName(department.departmentManager)}</span>
          </div>
        </div>
      </div>
